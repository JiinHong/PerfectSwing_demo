...
export default function ProfilePage() {
  ...
  return (
    <div className="h-full bg-gradient-to-br from-emerald-50 to-teal-50 px-6 py-8 flex flex-col justify-center">
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-gray-900 mb-2 font-inter">Profile</h1>
        <p className="text-gray-600 font-inter">My Tennis Analysis Status</p>
      </div>
      ...
      <div className="bg-white rounded-2xl p-6 shadow-sm mb-6">
        <div className="flex items-center gap-4 mb-4">
          ...
          <div>
            <h2 className="text-xl font-semibold text-gray-900">Tennis Lover</h2>
            <p className="text-gray-600">Perfect Swing User</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-3 gap-4 text-center">
          <div>
            ...
            <div className="text-sm text-gray-500">Total Swings</div>
          </div>
          <div>
      ...
      <div className="bg-white rounded-2xl p-6 shadow-sm mb-6">
        ...
        <div className="flex items-center gap-3 p-3 bg-emerald-50 rounded-lg">
          ...
          <div>
            <p className="font-semibold text-gray-900">Consistent Practitioner</p>
            <p className="text-sm text-gray-600">7 days consecutive practice achieved</p>
          </div>
        </div>
      </div>
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between py-2">
            <div className="flex items-center gap-3">
              ...
              <span className="text-gray-900">Analysis Notifications</span>
            </div>
          ...
          <div className="flex items-center justify-between py-2">
            <div className="flex items-center gap-3">
              ...
              <span className="text-gray-900">Advanced Analysis</span>
            </div>
